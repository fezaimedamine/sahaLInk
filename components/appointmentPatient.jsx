...
function AppointmentsPatient({ id }) {
  ...
  useEffect(() => {
    const fetchAppointments = async () => {
      ...
      // Fetch future appointments and related doctor information
                ...
                {appointment.doctors ? (
                  <>
                    ...
                    <p className="mt-1">
                      ...
                      {appointment.doctors.state}
                    </p>
                    <p className="mt-1">
                      <span className="text-black font-semibold">Speciality: </span>
                      {appointment.doctors.specialty}
                    </p>
                  </>
                ) : (
                  <p className="text-red-500 mt-2">Doctor information not available.</p>
                )}
              </div>
